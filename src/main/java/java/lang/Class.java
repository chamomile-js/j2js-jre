...
public final class Class<T> implements java.io.Serializable {
    ...
    private static final Map<String, Class<?>> classesByName = new HashMap<String, Class<?>>();
    ...
    /**
     * Returns the class loader for the class. This implementation returns
     * always {@code null} indicated that thes class was loaded by the bootstrap
     * class loader.
     * 
	...
	for (int i = 0, j = 0; i < signatures.length; i++) {
	    ...
	    // variables.
	    if (signature.startsWith("<init>") || signature.startsWith("<clinit>") || signature.indexOf("(") == -1) {
		continue;
	    }

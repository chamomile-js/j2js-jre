...
/**
 * Helper class for {@link javax.script.ScriptEngine}. It overloads the put and
 * eval method to make passing primitive types to and from JavaScript easy.
 * 
 * @author j2js.com
 */
public final class ScriptHelper {
	...
	/**
	 * Sets a key/value pair of <code>primitive</code> type, except of type
	 * <code>boolean</code>.
	 */
